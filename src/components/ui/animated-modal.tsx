    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className='fixed [perspective:800px] [transform-style:preserve-3d] inset-0 h-full w-full flex items-start justify-center z-50'
        >
          <Overlay />
...
const CloseIcon = () => {
  ...
  return (
    <button
      ...
      className='absolute top-4 right-8 group text-white'
    >
      <FaTimes size='1.2rem' />
    </button>
  );
